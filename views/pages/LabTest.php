...
else
{
    ...
    $query = mysqli_query($con,"select *,patient.name as PName,doctor.name as DocName from lab_test left join patient on lab_test.mrno=patient.mrno left join doctor on lab_test.doctor_code=doctor.emp_code where lab_test.mrno='".$_GET['mr']."';");
                            ...
                            <div class="row">
                                <div class="col s12">
                                    <div class="row">
                                        ...
                                        <div class="col s8">
                                            <h3 class="blue-text">Test Conduction Slip</h3>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col s10">
                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                            ...
                                            $query = mysqli_query($con, "select * from lab_test where mrno='" . $_GET['mr'] . "';");
