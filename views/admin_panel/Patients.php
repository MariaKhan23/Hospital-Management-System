...
<body class="vertical-layout page-header-light vertical-menu-collapsible vertical-gradient-menu preload-transitions 2-columns   " data-open="click" data-menu="vertical-gradient-menu" data-col="2-columns">
    ...
    <script>
        ...
        function RegisterOnlinePatient(e) {
            ...
            contactinfo = e.parentNode.parentNode.childNodes[5].innerHTML
            age = e.parentNode.parentNode.childNodes[3].innerHTML
            $('#txtPatientName').val(name)
            $('#txtPatientAge').val(age)
            $('#txtContactInfo').val(contactinfo)
            $('#txtCNIC').val(e.parentNode.parentNode.childNodes[7].innerHTML)
        }
    </script>
</body>
