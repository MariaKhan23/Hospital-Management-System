                                ...
                                <div class="row">
                                    <div class="col s6 container">
                                        <input type="text" value="<?php if (isset($emp_data)) {
                                                                        echo $emp_data['name'];
                                                                    } ?>" name="name" placeholder="Name" id="txtStaffName">
                                    </div>
                                    <div class="col s6">
                                        <input type="text" value="<?php if (isset($emp_data)) {
                                                                        echo $emp_data['fname'];
                                                                    } ?>" placeholder="Father Name" name="fname" id="txtStaffFatherName">
                                    </div>
                                    <div class="col mt-2 s6">
                                        <input type="number" value="<?php if (isset($emp_data)) {
                                                                        echo $emp_data['age'];
                                                                    } ?>" placeholder="Staff Age" name="age" id="txtStaffAge">
                                    </div>
                                    <div class="col mt-2 s6">
                                        <input type="email" value="<?php if (isset($emp_data)) {
                                                                        echo $emp_data['email'];
                                                                    } ?>" name="email" placeholder="Email Address" id="txtStaffEmail">
                                    </div>
                                    <div class="col mt-2 s6">
                                        <input type="number" value="<?php if (isset($emp_data)) {
                                                                        echo $emp_data['contactinfo'];
                                                                    } ?>" name="contactinfo" placeholder="Contact Info" id="txtStaffContactInfo">
                                    </div>
                                    <div class="col mt-2 s6">
                                        <input type="number" value="<?php if (isset($emp_data)) {
                                                                        echo $emp_data['cnic'];
                                                                    } ?>" name="cnic" placeholder="CNIC No." id="txtStaffCNIC">
                                    </div>
                                    <div class="col mt-2 s6">
                                    ...
                                    <div class="col mt-2 s12">
                                        <input type="text" value="<?php if (isset($emp_data)) {
                                                                        echo $emp_data['address'];
                                                                    } ?>" name="address" placeholder="Permenant Address" id="txtAddress">
                                    </div>
                                    <div class="col mt-2 s12">
